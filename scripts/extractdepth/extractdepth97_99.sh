...
-V data/vcf/hard_filter/scaf_97,scaf_98,scaf_99.filtered.nocall.snps.vcf.gz -F CHROM -F POS -GF GT -GF DP \
-O data/reports/variantstotable/scaf_97_99.DP.table
